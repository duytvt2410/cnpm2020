...
<form class="form-login-regeter" action="<%=Utils.fullPath("dangnhap")%>" method="post">
    ...
    <div class=" login-geter">
        ...
        <button class="login-buton" type="button" style="background: #2851A3 !important" onclick="window.location.href='https://www.facebook.com/dialog/oauth?client_id=608201396794677&redirect_uri=http://localhost:8080/dangnhapbangFB';"><i class="fab fa-facebook-square" style="font-size: 20px"></i><span style="color: #fefefe"> Đăng nhập bằng Facebook</span></button>
		
		<button class="login-buton" type="submit" style="background: #EA4335 !important" onclick="window.location.href='https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/dangnhapbangGG&response_type=code&client_id=762420684607-446oiurdkq6ns7pugjdf226emlm0in7t.apps.googleusercontent.com&approval_prompt=force';"><i class="fab fa-google" style="font-size: 20px"></i><span style="color: #fefefe"> Đăng nhập bằng Google</span></button>
